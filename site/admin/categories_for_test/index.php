...
<div class="container">
    ...
    <div class="styles col-10">
        ...
        <div class="row title-table">
            ...
            <div class="category_id col-1">ID</div>
            <div class="category_name col-3">Название категории</div>
            <div class="red col-2">Управление</div>
        </div>
        <?php foreach ($categories as $key => $category): ?>
            <div class="row style">
                <div class="category_id col-1"><?=$category['category_id']; ?></div>
                <div class="category_name col-3"><?=$category['category_name'];  ?></div>
                <div class="red col-1"><a href="edit.php?category_id=<?=$category['category_id']; ?>">edit</a></div>
