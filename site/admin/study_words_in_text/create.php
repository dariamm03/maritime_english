...
<div class="container">
    ...
    <div class="styles col-9">
        <div class="button row">
            ...
            <a href="<?php echo BASE_URL . "admin/study_words_in_text/admin.php";?>" class="col-3 btn btn-warning">Редактировать</a>
        </div>
        ...
        <div class="row add-style">
            ...
            <form action="create.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    <button name="word-create" class="btn btn-primary" type="submit">Сохранить запись</button>
                </div>
            </form>
        </div>
    </div>
