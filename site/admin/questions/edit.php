    ...
    <div class="styles col-9">
        ...
        <div class="row add-style">
            ...
            <form action="edit.php" method="post" enctype="multipart/form-data">
                <input name="question_code" value="<?=$question_code;?>" type="hidden">
                <div class="col">
                    <input name="text" value="<?=$text;?>" type="text" class="form-control" placeholder="Текст вопроса" aria-label="Текст вопроса">
                </div>
                <div class="col">
                ...
                <div class="input-group col mb-4 mt-4">
                    <input name="picture" value="<?=$picture;?>" type="file" class="form-control" id="inputGroupFile02">
                    <label class="input-group-text" for="inputGroupFile02">Upload</label>
                </div>
                <div class="input-group col mb-4 mt-4">
                    <input name="audio" value="<?=$audio;?>" type="file" class="form-control" id="inputGroupFile02">
                    <label class="input-group-text" for="inputGroupFile02">Upload</label>
                </div>
                <div class="col">
                    <button name="question-edit" class="btn btn-primary" type="submit">Обновить запись</button>
                </div>
            </form>
        </div>
    </div>
