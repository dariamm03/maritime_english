...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['search-term'])){
    $questions = searchAdminQuestions($_POST['search-term'], 'questions');
}
?>
...
<head>
    ...
    <title>Freak Dance Studio</title>
...
<div class="container">
    ...
    <div class="styles col-9">
        <div class="button row">
            ...
            <a href="<?php echo BASE_URL . "admin/questions/index.php";?>" class="col-2 btn btn-danger">Назад</a>
        </div>
        <h2>
